<?php
	$our_plugins = [
		"Carbon Icons" => [
			"Name" => "Carbon Icons",
			"Description" => __( "Enhance your content creation with Carbon Icons, a dynamic WordPress plugin designed to elevate your block editor experience. Choose from an extensive selection of modern and complexe SVG icons to effortlessly enrich your website's appearance.", "carbon-icons" ),
			"Dashboard" => home_url( "/wp-admin/admin.php?page=carbon-icons#/" ),
			"License" => home_url( "/wp-admin/admin.php?page=carbon-icons#/license/" ),
			"isComing" => false
		],
		"Carbon Blocks" => [
			"Name" => "Carbon Blocks",
			"Description" => __( "Unleash your creativity with Carbon Blocks, an ingenious WordPress plugin that expands the potential of your block editor. Seamlessly create captivating layouts and designs to enrich your website's visual appeal.", "carbon-icons" ),
			"GetStarted" => "",
			"LearnMore" => "",
			"isNew" => true,
			"isComing" => false
		...
		"Carbon Sliders" => [
			"Name" => "Carbon Sliders",
			"Description" => __( "Engage your visitors with Carbon Sliders, an exceptional WordPress plugin designed to help you build captivating image and content sliders effortlessly. Elevate your website's appeal and leave a lasting impression on your audience.", "carbon-icons" ),
			"GetStarted" => "",
			"LearnMore" => "",
			"isNew" => false,
			"isComing" => true
...
<section class="carbon-plugins">
	<h1>
		<?php
			...
			$morning_message 		= __("Good morning ", "carbon-icons");
			$afternoon_message 	= __("Good afternoon ", "carbon-icons");
			$evening_message 		= __("Good evening ", "carbon-icons");
			$night_message 			= __("Good night ", "carbon-icons");
			...
			if (is_user_logged_in()) {
				...
				echo esc_html( __("guest !", "carbon-icons") );
			}
		?>
	</h1>
	<div>
		<section class="carbon-plugins__plugins">
			<section class="carbon-plugins__installed">
				<h2><?php echo esc_html( __( "Currently installed plugins", "carbon-icons" ) ); ?></h2>
				<?php
					$plugins 					= get_plugins();
						...
						<article class="active">
							<header>
								...
								<span class="badge minor">
									...
									<?php echo esc_html( __( "Active", "carbon-icons" ) ); ?>
								</span>
							</header>
							<section>
						...
						<article class="inactive">
							<header>
								...
								<span class="badge major">
									<span class="flex w-3 h-3 rounded-full"></span>
									<?php echo esc_html( __("Inactive", "carbon-icons") ); ?>
								</span>
							</header>
						</article>
					<?php endforeach;
			...
			<section class="carbon-plugins__others">
				<h2><?php echo esc_html( __("Our other plugins", "carbon-icons") ); ?></h2>
					<?php
						...
						if (!empty($missing_plugins)) :
							foreach ($missing_plugins as $plugin_name => $plugin_data) :
								...
								<article class="<?php echo $isNew ? esc_html( "is-new" ) : ( $isComing ? esc_html( "is-coming" ) : esc_html( "" ) ); ?>">
									<header>
										...
										<?php if($isNew) : ?>
										<span class="badge is-new"><?php echo esc_html( __( "New", "carbon-icons" ) ); ?></span>
										<?php endif; ?>
										<?php if($isComing) : ?>
											<span class="badge is-coming"><?php echo esc_html( __( "Coming soon", "carbon-icons" ) ); ?></span>
										<?php endif; ?>
									</header>
							...
							echo '<p>' .esc_html( __("All plugins are installed ! Thank you for your loyalty :)", "carbon-icons") ) . '</p>';
						endif;
					?>
			</section>
		</section>
		<?php if (function_exists('simplexml_load_file')) : ?>
			<section class="carbon-plugins__rss">
				<section class="carbon-plugins__releases">
					<h2><?php echo esc_html( __( "Latest releases", "carbon-icons" ) ); ?></h2>
					<section>
						<?php
							...
							if ($xml) :
								foreach ($xml->channel->item as $item) :
									?> <a href="<?php echo esc_html( $item->link ); ?>">
										<article>
											...
											<p>
												<?php echo esc_html( __("Read more", "carbon-icons") ); ?>
								...
								echo esc_html( __("Cannot read RSS.", "carbon-icons") );
							endif;
						?>
					</section>
				</section>
				<section class="carbon-plugins__news">
					<h2><?php echo esc_html( __("News from our blog", "carbon-icons") ); ?></h2>
					<section>
						<?php
