...
if ( ! class_exists( 'Crbn_Blcks_Activator' ) ) :
	...
	class Crbn_Blcks_Activator {
		...
		public static function activate() {
			...
			$plugins_to_check = ['carbon-blocks-pro/carbon-blocks-pro.php', 'carbon-icons/carbon-icons.php', 'carbon-icons-pro/carbon-icons-pro.php'];
		...
		public static function display_activation_error_message() {
			...
			$message = __( "Some other Carbon Plugins can't be activated at the same time that Carbon Blocks. They have been deactivated.", 'carbon-blocks' );
			?>
