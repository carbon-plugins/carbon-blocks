<?php
	...
	$our_plugins = [
		"Carbon Icons" => [
			...
			"LearnMore" => "https://carbon-plugins.com/plugins/carbon-icons/",
			"isComing" => false
		],
		"Carbon Blocks" => [
			"Name" => "Carbon Blocks",
			...
			"LearnMore" => "https://carbon-plugins.com/plugins/carbon-blocks/",
			"isNew" => true,
			"isComing" => false
		],
		"Carbon Sliders" => [
			...
			"LearnMore" => "https://carbon-plugins.com/plugins/carbon-sliders/",
			"isNew" => false,
			"isComing" => true
		]
	];
