...
import SvgAdvancedButton from '/src/assets/block-icons/AdvancedButton';

registerBlockType( 'carbon-blocks/advanced-button', {
	icon: SvgAdvancedButton,
	title: __( "Advanced button", 'carbon-blocks' ),
	description: __("Drive interaction on your site with a dynamic button; add a personalized link and customize it easily.", 'carbon-blocks' ),
	example: {
    attributes: {
      text: __( 'Button', 'carbon-blocks'),
      style: {
				color: {
					background: "black",
					text: "white"
	...
	save,
	// styles: [
	// 	{ name: "fill", label: __( "Fill", "carbon-blocks" ), isDefault: true },
	// 	{ name: "outline", label: __( "Outline", "carbon-blocks" ) },
	// ],
} );
